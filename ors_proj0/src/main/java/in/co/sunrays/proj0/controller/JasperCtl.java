...
public class JasperCtl {
	...
	public void display(HttpServletRequest request, HttpServletResponse response) throws JRException, SQLException, IOException {
		...
		String path = context.getRealPath("F:\\Pawan Proj\\ors_proj0\\src\\main\\webapp\\resources\\Report\\Pawan.jrxml");
		System.out.println("in jasper");
		Connection con = null;
		JasperReport jasperReport = JasperCompileManager.compileReport("F:\\Pawan Proj\\ors_proj0\\src\\main\\webapp\\resources\\Report\\Pawan.jrxml");
